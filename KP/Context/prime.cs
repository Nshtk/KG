...
namespace KP.Context
{
    public static class Primality
    {
        ...
        public static bool performFermatTest(BigInteger number, float probability_minimal)
        {
            if(number == 0)
                return false;
        ...
        public static bool performSolovayStrassenTest(BigInteger number, float probability_minimal)
        {
            if(number==0)
                return false;
        ...
        public static bool performMillerRabinTest(BigInteger number, float probability_minimal)
        {
